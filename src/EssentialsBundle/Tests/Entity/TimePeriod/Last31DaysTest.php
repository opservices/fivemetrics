...
use EssentialsBundle\Entity\TimePeriod\Last31Days;

class Last31DaysTest extends TimePeriodTest
{
    protected function setUp()
    {
        $this->timePeriod = new Last31Days();
    }

    /**
     * @testdox Verify whether current tests are being executed on TimPeriodLast31Days class.
     * @test
     */
    public function isAnInstanceOfTimePeriodLast31Days()
    {
        $this->assertInstanceOf(Last31Days::class, $this->timePeriod);
    }
